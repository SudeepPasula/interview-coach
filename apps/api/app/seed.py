...
SEED = [
    Question(role="SWE", text="Tell me about a challenging bug you fixed.",
             key_points=["root cause analysis","debugging steps","tools used","impact","lesson learned"]),
    Question(role="SWE", text="Describe a system you designed.",
             key_points=["requirements","trade-offs","scalability","bottlenecks","monitoring"]),
    Question(role="SWE", text="Tell me about a time you improved a process.",
